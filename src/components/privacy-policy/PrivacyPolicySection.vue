<template>
    <div class="privacy-policy-section-background">
        <div class="privacy-policy-section-container">
            ...
            <ul>
                ...
                <li>
                    <p>
                        ...
                        {{ companyName }}, {{ companyAddress }}, United States.
                    </p>
                </li>
                <li>
                    <p>
                ...
                <li>
                    <p>
                        <strong>Website</strong> refers to {{ companyName }},
                        accessible from
                        <a
                            href="https://www.menh.llc"
                            rel="external nofollow noopener"
                            target="_blank"
                            >https://www.menh.llc</a
                        >
                    </p>
                </li>
                <li>
            ...
            <ul>
                <li>
                    <p>By email: {{ companyEmail }}</p>
                </li>
                <li>
                    <p>By phone number: {{ companyPhoneNumber }}</p>
                </li>
                <li>
                    <p>By mail: {{ companyAddress }}, United States</p>
                </li>
            </ul>
        </div>
    </div>
...
<style lang="scss" scoped>
    ...
    .privacy-policy-section-container a {
        color: rgb(var(--color-text));
    }
    .privacy-policy-section-container h1 {
        font-weight: 700;
