<template>
    <div class="terms-and-conditions-section-background">
        <div class="terms-and-conditions-section-container">
            <h1>Terms of Service</h1>
            <p>Last updated: June 30, 2021</p>
            <h2>Overview</h2>
            <p>
                This website is operated by {{ companyName }}. Throughout the
                site, the terms &ldquo;we&rdquo;, &ldquo;us&rdquo; and
                &ldquo;our&rdquo; refer to {{ companyName }}.
                {{ companyName }} offers this website, including all
            ...
            <p>
                ...
                of the site, you agree to be bound by these Terms of Service. If
            ...
            <p>
                ...
                party&rsquo;s intellectual property or these Terms of
            ...
            <p><br /></p>
            <h2>
                Section 13 - Disclaimer of Warranties; Limitiation of Liability
            </h2>
            <p>
            ...
            <p>
                ...
                no case shall {{ companyName }}, our directors, officers,
            ...
            <p>
                ...
                {{ companyName }} and our parent, subsidiaries, affiliates,
            ...
            <p>
                ...
                accordance with the laws of {{ companyAddress }}, United States.
            </p>
            <p><br /></p>
...
<style lang="scss" scoped>
    ...
    .terms-and-conditions-section-container h1 {
        font-weight: 700;
        font-size: calc(var(--font-size-desktop-h1) * 0.5);
    }
    .terms-and-conditions-section-container h2 {
        font-weight: 700;
        font-size: calc(var(--font-size-desktop-h2) * 0.7);
    }
    .terms-and-conditions-section-container p {
        font-weight: 400;
    ...
    @media screen and (max-width: 600px) {
        ...
        .terms-and-conditions-section-container h1 {
            font-weight: 700;
            font-size: calc(var(--font-size-mobile-h1) * 0.5);
        }
        .terms-and-conditions-section-container h2 {
            font-weight: 700;
            font-size: calc(var(--font-size-mobile-h2) * 0.7);
        }
        .terms-and-conditions-section-container p {
            font-weight: 400;
            font-size: calc(var(--font-size-mobile-p) * 0.7);
        }
    }
</style>
